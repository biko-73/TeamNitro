...
gettext.bindtextdomain("WeatherMSN", "%s%s" % (resolveFilename(SCOPE_PLUGINS), "Extensions/TeamNitro/locale"))
...
SKIN_MSN = """
<screen name="WeatherMSN" position="0,0" size="1920,1080" title=" " backgroundColor="transparent" flags="wfNoBorder">
  <widget source="global.CurrentTime" render="Label" position="1520,85" size="250,100" font="LCD; 90" valign="center" halign="center" foregroundColor="white" backgroundColor="black" transparent="1" zPosition="2">
    <convert type="ClockToText">Format:%H:%M</convert>
  </widget>
  <widget source="global.CurrentTime" text=":60" render="Label" position="1735,115" size="84,60" zPosition="2" font="LCD; 50" valign="center" halign="right" foregroundColor="#8cff" backgroundColor="black" transparent="1">
    <convert type="ClockToText">Format::%S</convert>
  </widget>
  <widget source="global.CurrentTime" render="Label" position="1490,171" size="340,50" backgroundColor="black" transparent="1" zPosition="1" font="Regular; 40" valign="center" halign="center">
    <convert type="ClockToText">Format:%d.%m.%Y</convert>
  </widget>
  <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TeamNitro/images/Source2.png" position="0,0" size="1920,1080" alphatest="off" zPosition="-10" />
  <!-- WeatherMSN Source2-->
  <widget source="observationpoint" render="Label" position="80,45" size="310,35" font="Regular; 30" foregroundColor="#f4f4f4" backgroundColor="background" halign="center" transparent="1" />
  <eLabel text="Timezone:" position="80,80" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="timezone" render="Label" position="210,80" size="180,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="center" transparent="1" />
  <eLabel text="Latitude:" position="80,110" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="latitude" render="Label" position="210,110" size="180,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="center" transparent="1" />
  <eLabel text="Longitude:" position="80,139" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="longitude" render="Label" position="210,140" size="180,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="center" transparent="1" />
  <widget source="temperature" render="Label" position="800,40" size="190,150" font="Regular; 80" foregroundColor="#f4f4f4" backgroundColor="background" valign="center" halign="center" transparent="1" />
  <eLabel text="Feelslike:" position="995,70" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="feelslike" render="Label" position="1110,70" size="180,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="center" transparent="1" />
  <eLabel text="Humidity:" position="995,100" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="humidity" render="Label" position="1110,100" size="180,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="center" transparent="1" />
  <eLabel text="Sky:" position="995,130" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="skytext" render="Label" position="1110,130" size="180,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="center" transparent="1" />
  <eLabel text="Wind:" position="995,160" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="wind" render="Label" position="1110,160" size="180,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="center" transparent="1" />

  <eLabel text="Moonphase:" position="1380,510" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="1510,510" size="110,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Moonphase</convert>
  </widget>
  <eLabel text="Moonlight:" position="1380,540" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="1510,540" size="110,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Moonlight</convert>
  </widget>
  <eLabel text="Moonazimuth:" position="1380,570" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="1510,570" size="110,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Moonazimuth</convert>
  </widget>
  <eLabel text="Julianday:" position="1380,600" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="1470,600" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Julianday</convert>
  </widget>
  <widget name="pic" position="650,40" size="150,150" scale="1" zPosition="2" alphatest="blend" />
  <widget name="picmoon" position="1425,250" size="150,150" scale="1" zPosition="2" alphatest="blend" />

  <!--Day-00-->
  <widget name="pic0" position="75,250" size="150,150" scale="1" zPosition="2" alphatest="blend" />
  <widget source="date0" render="Label" position="100,475" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <widget source="day0" render="Label" position="100,505" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <widget source="temperature0" render="Label" position="100,535" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <widget source="precip0" render="Label" position="100,565" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <widget source="skytext0" render="Label" position="100,595" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <eLabel text="Date:" position="35,475" size="170,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <eLabel text="Day:" position="35,505" size="170,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <eLabel text="Temp:" position="35,535" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <eLabel text="Precip:" position="35,565" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <eLabel text="Sky:" position="35,595" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />


  <!--Day-01-->
  <widget name="pic1" position="345,250" size="150,150" scale="1" zPosition="2" alphatest="blend" />
  <widget source="date1" render="Label" position="370,475" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <widget source="day1" render="Label" position="370,505" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <widget source="temperature1" render="Label" position="370,535" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <widget source="precip1" render="Label" position="370,565" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <widget source="skytext1" render="Label" position="370,595" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <eLabel text="Date:" position="310,475" size="170,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <eLabel text="Day:" position="310,505" size="170,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <eLabel text="Temp:" position="310,535" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <eLabel text="Precip:" position="310,565" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <eLabel text="Sky:" position="310,595" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />


  <!--Day-02-->
  <widget name="pic2" position="615,250" size="150,150" scale="1" zPosition="2" alphatest="blend" />
  <widget source="date2" render="Label" position="640,475" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <widget source="day2" render="Label" position="640,505" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <widget source="temperature2" render="Label" position="640,535" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <widget source="precip2" render="Label" position="640,565" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <widget source="skytext2" render="Label" position="640,595" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <eLabel text="Date:" position="580,475" size="170,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <eLabel text="Day:" position="580,505" size="170,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <eLabel text="Temp:" position="580,535" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <eLabel text="Precip:" position="580,565" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <eLabel text="Sky:" position="580,595" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />

  <!--Day-03-->
  <widget name="pic3" position="885,250" size="150,150" scale="1" zPosition="2" alphatest="blend" />
  <widget source="date3" render="Label" position="910,475" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <widget source="day3" render="Label" position="910,505" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <widget source="temperature3" render="Label" position="910,535" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <widget source="precip3" render="Label" position="910,565" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <widget source="skytext3" render="Label" position="910,595" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <eLabel text="Date:" position="850,475" size="170,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <eLabel text="Day:" position="850,505" size="170,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <eLabel text="Temp:" position="850,535" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <eLabel text="Precip:" position="850,565" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <eLabel text="Sky:" position="850,595" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />

  <!--Day-04-->
  <widget name="pic4" position="1150,250" size="150,150" scale="1" zPosition="2" alphatest="blend" />
  <widget source="date4" render="Label" position="1180,475" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <widget source="day4" render="Label" position="1180,505" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <widget source="temperature4" render="Label" position="1180,535" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <widget source="precip4" render="Label" position="1180,565" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <widget source="skytext4" render="Label" position="1180,595" size="160,30" font="Regular; 25" foregroundColor="#f4f4f4" backgroundColor="background" halign="right" transparent="1" />
  <eLabel text="Date:" position="1130,475" size="170,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <eLabel text="Day:" position="1130,505" size="170,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <eLabel text="Temp:" position="1130,535" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <eLabel text="Precip:" position="1130,565" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <eLabel text="Sky:" position="1130,595" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />

  
  <!-- Earth Logo-->
  <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TeamNitro/ICONS/sonnensys/earth.png" scale="1" position="480,40" size="150,150" alphatest="blend" />
  <!-- Sonne -->
  <eLabel text="Sunrise:" position="1650,525" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="1740,525" size="150,30" font="Regular; 25" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Sunrise</convert>
  </widget>
  <eLabel text="Sunset:" position="1650,555" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="1740,555" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Sunset</convert>
  </widget>
  <eLabel text="Solstice:" position="1650,585" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="1740,585" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Solstice</convert>
  </widget>
  <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TeamNitro/ICONS/sonnensys/sun.png" scale="1" position="1695,250" size="150,150" alphatest="blend" />
  <!-- Sonne -->
  <!-- mercury -->
  <eLabel text="Mercuryrise:" position="35,930" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="160,930" size="110,30" font="Regular; 25" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Mercuryrise</convert>
  </widget>
  <eLabel text="Mercuryset:" position="35,960" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="160,960" size="110,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Mercuryset</convert>
  </widget>
  <eLabel text="Culmination:" position="35,990" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="160,990" size="110,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Mercuryculmination</convert>
  </widget>
  <eLabel text="Azimuth:" position="35,1020" size="180,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="160,1020" size="110,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Mercuryazimuth</convert>
  </widget>
  <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TeamNitro/ICONS/sonnensys/mercury.png" scale="1" position="75,700" size="150,150" alphatest="blend" />
  <!-- mercury -->
  <!-- venus -->
  <eLabel text="Venusrise:" position="310,930" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="440,930" size="100,30" font="Regular; 25" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Venusrise</convert>
  </widget>
  <eLabel text="Venusset:" position="310,960" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="440,960" size="100,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Venusset</convert>
  </widget>
  <eLabel text="Culmination:" position="310,990" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="440,990" size="100,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Venusculmination</convert>
  </widget>
  <eLabel text="Azimuth:" position="310,1020" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="440,1020" size="100,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Venusazimuth</convert>
  </widget>
  <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TeamNitro/ICONS/sonnensys/venus.png" scale="1" position="345,700" size="150,150" alphatest="blend" />
  <!-- venus -->
  <!-- mars -->
  <eLabel text="Marsrise:" position="580,930" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="710,930" size="100,30" font="Regular; 25" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Marsrise</convert>
  </widget>
  <eLabel text="Marsset:" position="580,960" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="710,960" size="100,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Marsset</convert>
  </widget>
  <eLabel text="Culmination:" position="580,990" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="710,990" size="100,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Marsculmination</convert>
  </widget>
  <eLabel text="Azimuth:" position="580,1020" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="710,1020" size="100,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Marsazimuth</convert>
  </widget>
  <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TeamNitro/ICONS/sonnensys/mars.png" scale="1" position="615,700" size="150,150" alphatest="blend" />
  <!-- mars -->
  <!-- jupiter -->
  <eLabel text="Jupiterrise:" position="850,930" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="980,930" size="100,30" font="Regular; 25" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Jupiterrise</convert>
  </widget>
  <eLabel text="Jupiterset:" position="850,960" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="980,960" size="100,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Jupiterset</convert>
  </widget>
  <eLabel text="Culmination:" position="850,990" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="980,990" size="100,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Jupiterculmination</convert>
  </widget>
  <eLabel text="Azimuth:" position="850,1020" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="980,1020" size="100,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Jupiterazimuth</convert>
  </widget>
  <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TeamNitro/ICONS/sonnensys/jupiter.png" scale="1" position="885,700" size="150,150" alphatest="blend" />
  <!-- jupiter -->
  <!-- Saturn -->
  <eLabel text="Saturnrise:" position="1120,930" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="1250,930" size="100,30" font="Regular; 25" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Saturnrise</convert>
  </widget>
  <eLabel text="Saturnset:" position="1120,960" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="1250,960" size="100,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Saturnset</convert>
  </widget>
  <eLabel text="Culmination:" position="1120,990" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="1250,990" size="100,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Saturnculmination</convert>
  </widget>
  <eLabel text="Azimuth:" position="1120,1020" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="1250,1020" size="100,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Saturnazimuth</convert>
  </widget>
  <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TeamNitro/ICONS/sonnensys/saturn.png" scale="1" position="1155,700" size="150,150" alphatest="blend" />
  <!-- Saturn -->
  <!-- Uranus -->
  <eLabel text="Uranusrise:" position="1390,930" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="1520,930" size="100,30" font="Regular; 25" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Uranusrise</convert>
  </widget>
  <eLabel text="Uranusset:" position="1390,960" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="1520,960" size="100,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Uranusset</convert>
  </widget>
  <eLabel text="Culmination:" position="1390,990" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="1520,990" size="100,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Uranusculmination</convert>
  </widget>
  <eLabel text="Azimuth:" position="1390,1020" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="1520,1020" size="100,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Uranusazimuth</convert>
  </widget>
  <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TeamNitro/ICONS/sonnensys/uranus.png" scale="1" position="1425,700" size="150,150" alphatest="blend" />
  <!-- Saturn -->
  <!-- Neptune -->
  <eLabel text="Neptunerise:" position="1660,930" size="145,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="1780,930" size="110,30" font="Regular; 25" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Neptunerise</convert>
  </widget>
  <eLabel text="Neptuneset:" position="1660,960" size="160,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="1780,960" size="110,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Neptuneset</convert>
  </widget>
  <eLabel text="Culmination:" position="1660,990" size="160,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="1780,990" size="110,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Neptuneculmination</convert>
  </widget>
  <eLabel text="Azimuth:" position="1660,1020" size="150,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="left" transparent="1" />
  <widget source="session.CurrentService" render="Label" position="1780,1020" size="110,30" font="Regular; 25" foregroundColor="foreground" backgroundColor="background" halign="right" transparent="1">
    <convert type="TN_MSNWeather">Neptuneazimuth</convert>
  </widget>
  <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TeamNitro/ICONS/sonnensys/neptune.png" scale="1" position="1695,700" size="150,150" alphatest="blend" />
</screen>"""
...
class WeatherMSN(Screen):
	def __init__(self, session):
		...
		self["nateventstxt"] = StaticText(_("Natural events:"))
...
# sidereal time
		...
		STT = math.fmod((6.697374558333 + 2400.0513369072223 * T + 0.0000258622 * T * T - 0.00000000172 * T * T * T), 24) # sidereal time in Greenwich at midnight
		ST = math.fmod((STT + UT * 1.0027379093 - zone * 1.0027379093 + long / 15), 24) # local sidereal time at the moment of local time
		if ST < 0:
			ST = ST + 24
		ST = ST * 15 # sidereal time at the time of calculation in degrees
# Sunrise, sunset, climax
# Earth orbit
		T = (JDN - 2451545) / 36525
		LS = 280.4664568 + 36000.7697509 * T + 0.0003032 * T * T + 0.00000002 * T * T * T # sr length
		MS = 357.5291092 + 35999.0502909 * T - 0.0001537 * T * T - 0.00000004 * T * T * T # cf anomaly
		ES = 0.016708634 - 0.000042037 * T - 0.0000001267 * T * T # orbital eccentricity
		...
		DS = (1.000001018 * (1 - ES * ES)) / (ES * math.cos((MS + CS) * DEG2RAD) + 1) # distance to the sun in AU
...
# Mercury orbit
		LP1 = 178.179078 + 149474.07078 * T + 0.0003011 * T * T # sr long L
		wP1 = 28.753753 + 0.3702806 * T + 0.0001208 * T * T # perihelion argument w
		WP1 = 47.145944 + 1.1852083 * T + 0.0001739 * T * T # ascending node longitude W
		IP1 = 7.002881 + 0.0018608 * T - 0.0000183 * T * T # inclination on the plane of the ecliptic i
		EP1 = 0.20561421 + 0.00002046 * T - 0.000000030 * T * T # orbital eccentricity e
		...
		LP = LP1 + EL
		M0 = math.fmod(174.795 + 4.092317 * (JDN - 2451545), 360) # cf anomaly
		MP = M0 - EP1 * math.sin(M0 * DEG2RAD) # Kepler's equation
...
#
	...
	def get_widgets(self):
		defpic = "%sExtensions/TeamNitro/ICONS/weather/na.png" % resolveFilename(SCOPE_PLUGINS)
		...
		if self.pic['Pic'] != '':
			self["pic"].instance.setPixmapFromFile("%sExtensions/TeamNitro/ICONS/weather/%s.png" % (resolveFilename(SCOPE_PLUGINS), self.pic['Pic']))
		else:
...
# День 0
		...
		if self.pic0['Pic0'] != '':
			self["pic0"].instance.setPixmapFromFile("%sExtensions/TeamNitro/ICONS/weather/%s.png" % (resolveFilename(SCOPE_PLUGINS), self.pic0['Pic0']))
		else:
...
# День 1
		...
		if self.pic1['Pic1'] != '':
			self["pic1"].instance.setPixmapFromFile("%sExtensions/TeamNitro/ICONS/weather/%s.png" % (resolveFilename(SCOPE_PLUGINS), self.pic1['Pic1']))
		else:
...
# День 2
		...
		if self.pic2['Pic2'] != '':
			self["pic2"].instance.setPixmapFromFile("%sExtensions/TeamNitro/ICONS/weather/%s.png" % (resolveFilename(SCOPE_PLUGINS), self.pic2['Pic2']))
		else:
...
# День 3
		...
		if self.pic3['Pic3'] != '':
			self["pic3"].instance.setPixmapFromFile("%sExtensions/TeamNitro/ICONS/weather/%s.png" % (resolveFilename(SCOPE_PLUGINS), self.pic3['Pic3']))
		else:
...
# День 4
		...
		if self.pic4['Pic4'] != '':
			self["pic4"].instance.setPixmapFromFile("%sExtensions/TeamNitro/ICONS/weather/%s.png" % (resolveFilename(SCOPE_PLUGINS), self.pic4['Pic4']))
		else:
...
# Астро
		...
		if self.picmoon['PicMoon'] != '':
			self["picmoon"].instance.setPixmapFromFile("%sExtensions/TeamNitro/ICONS/moon/%s.png" % (resolveFilename(SCOPE_PLUGINS), self.picmoon['PicMoon']))
		else:
...
SKIN_CONF = """
		<!-- Config WeatherMSN -->
		<screen name="ConfigWeatherMSN" position="center,260" size="900,450" title=" " backgroundColor="transparent">
			<ePixmap position="0,0" size="900,450" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TeamNitro/images/city.png" alphatest="off" zPosition="-10" />
			<widget name="config" itemHeight="38" font="Regular; 32" position="20,61" size="860,380" scrollbarMode="showOnDemand" transparent="1" />
			<widget source="key_red" render="Label" position="78,10" size="200,45" font="Regular; 25" halign="left" valign="center" foregroundColor="#00f4f4f4" backgroundColor="background" transparent="1" />
			<widget source="key_green" render="Label" position="366,10" size="200,45" font="Regular; 25" halign="left" valign="center" foregroundColor="#00f4f4f4" backgroundColor="background" transparent="1" />
			<widget source="key_blue" render="Label" position="665,10" size="200,45" font="Regular; 25" halign="left" valign="center" foregroundColor="#00f4f4f4" backgroundColor="background" transparent="1" />
			<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TeamNitro/pic/red48x48.png" position="33,10" size="45,45" alphatest="blend" />
			<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TeamNitro/pic/green48x48.png" position="320,10" size="45,45" alphatest="blend" />
			<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TeamNitro/pic/blue48x48.png" position="620,10" size="45,45" alphatest="blend" />
...
class ConfigWeatherMSN(ConfigListScreen, Screen):
	def __init__(self, session):
		...
		self.pluginpath = "/usr/lib/enigma2/python/Plugins/Extensions/TeamNitro/components/"
		self.city = config.plugins.weathermsn.city.value
		self.language = config.osd.language.value.replace('_', '-')
		if self.language == 'en-EN':
			self.language = 'en-US'
	...
	def createConverter(self):
		os.system("cp %sTN_MSNWeather.py %sTN_MSNWeather.py" % (self.pluginpath, self.converterpath))
	...
	def save(self):
		...
		if config.plugins.weathermsn.converter.value == 'yes':
			...
			self.mbox = self.session.open(MessageBox, (_("Configuration is saved")), MessageBox.TYPE_INFO, timeout = 1)
			self.close()


SKIN_LOC = """
		<!-- Search LocationMSN -->
		<screen name="SearchLocationMSN" position="center,260" size="900,450" title=" " backgroundColor="transparent">
    		<ePixmap position="0,0" size="900,450" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/TeamNitro/images/city.png" alphatest="off" zPosition="-10" />
			<widget name="menu" position="20,60" size="910,380" itemHeight="38" font="Regular; 32" scrollbarMode="showOnDemand" transparent="1" />
		</screen>"""
