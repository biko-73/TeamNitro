...
wget -O /var/volatile/tmp/TeamNitro.tar.gz --no-check-certificate "https://raw.githubusercontent.com/biko-73/TeamNitro/main/skins/TeamNitro.tar.gz"
wget -O /var/volatile/tmp/Team_Nitro-by_BoHlala-V_1.0.tar.gz --no-check-certificate "https://raw.githubusercontent.com/biko-73/TeamNitro/main/skins/Team_Nitro-by_BoHlala-V_1.0.tar.gz"
